...
\
  ...
  { ZAP_EMPTY_DEFAULT(), 0x00000009, 1, ZAP_TYPE(BOOLEAN), 0 }, /* NTPServerAvailable */  \
...
// clang-format off
#define GENERATED_EVENT_COUNT 22
...
#define FIXED_DEVICE_TYPES {{0x00000016,1},{0x0000000A,1},{0x00000011,1}}
